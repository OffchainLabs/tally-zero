// Profile contract consumed by this UI, mirroring the indexer's SIWE types
// (packages/indexer/src/siwe/types.ts) wherever this UI reads them. The session
// response below carried only `address` and `profile` until acting-as-a-Safe
// gave the subject fields a caller.
